					...
					<div class="hex-row">
						...
						>
							...
							>
								...
								<path d="M3 21v-3l9-9" />
								<path
									d="m15 6 3.4-3.4a2.1 2.1 0 1 1 3 3L18 9l.4.4a2.1 2.1 0 1 1-3 3l-3.8-3.8a2.1 2.1 0 1 1 3-3l.4.4"
								/>
							</svg>
						</button>
					</div>
					...
					<div class="hsv-sliders">
						<div class="hsv-row">
							...
							<input
								...
								max="360"
								:value="hsv.h"
								@input="hsv.h = +$event.target.value; selectedHex = ''"
							/>
							<input
								type="number"
								min="0"
								max="360"
								:value="hsv.h"
								@input="hsv.h = clamp(+$event.target.value, 0, 360); selectedHex = ''"
							/>
						</div>
						<div class="hsv-row">
							<label>S</label>
							<input
								...
								@input="hsv.s = +$event.target.value; selectedHex = ''"
							/>
							<input
								type="number"
								min="0"
								max="100"
								:value="hsv.s"
								@input="hsv.s = clamp(+$event.target.value, 0, 100); selectedHex = ''"
							/>
						</div>
						<div class="hsv-row">
							<label>V</label>
							<input
								...
								@input="hsv.v = +$event.target.value; selectedHex = ''"
							/>
							<input
								type="number"
								min="0"
								max="100"
								:value="hsv.v"
								@input="hsv.v = clamp(+$event.target.value, 0, 100); selectedHex = ''"
							/>
						</div>
					</div>
